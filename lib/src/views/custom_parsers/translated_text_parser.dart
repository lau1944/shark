...
class TranslatedTextParser implements SharkParser {
  @override
  Widget parse(Map<String, dynamic> map, BuildContext buildContext,
      ClickListener? listener) {
    String? data = (map['data'] as String?)?.tr();
  ...
  @override
  String get widgetName => "TranslatedText";
